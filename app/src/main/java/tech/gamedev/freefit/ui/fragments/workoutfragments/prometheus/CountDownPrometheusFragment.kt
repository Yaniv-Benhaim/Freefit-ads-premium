...
class CountDownPrometheusFragment : Fragment(R.layout.fragment_five_second_count_down) {
            ...
            override fun onTick(millisUntilFinished: Long) {
                ...
                if (millisUntilFinished / 1000 != 0L) {
                    ...
                    if (tvCountDownTimer != null) {
                        findNavController().navigate(R.id.action_countDownPrometheusFragment_to_prometheusWorkoutViewFragment)
                    }
                }
