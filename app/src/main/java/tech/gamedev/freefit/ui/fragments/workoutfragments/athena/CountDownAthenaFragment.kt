package tech.gamedev.freefit.ui.fragments.workoutfragments.athena
...
class CountDownAthenaFragment : Fragment(R.layout.fragment_five_second_count_down) {
            ...
            override fun onTick(millisUntilFinished: Long) {
                ...
                if (millisUntilFinished / 1000 != 0L) {
                    ...
                    if (tvCountDownTimer != null) {
                        findNavController().navigate(R.id.action_countDownAthenaFragment_to_athenaWorkoutViewFragment)
                    }
                }
