...
import tech.gamedev.freefit.data.db.other.Constants.REQUEST_CODE_LOCATION_PERMISSIONS
...
import tech.gamedev.freefit.ui.adapters.RunAdapter
...
class RunFragment : Fragment(R.layout.run_fragment), EasyPermissions.PermissionCallbacks,
    RunAdapter.OnItemDeleteClickListener {
    ...
    override fun onPermissionsDenied(requestCode: Int, perms: MutableList<String>) {
        ...
        //if permissions are denied this dialog will lead the user to the settings
    ...
    override fun onItemClickDelete(run: Run) {
